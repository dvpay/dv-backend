...
class WebhookSuccessNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mailMessage = (new MailMessage())
                ...
                ->line(__('Amount: *:amount* :currency', ['amount' => $this->invoice->amount, 'currency' => $currencyCode]))
                ->line(__('Received: *:amount* :currency', ['amount' => $this->data['receivedAmount'], 'currency' => $currencyCode]))
