...
enable_queue() {
cat > /etc/systemd/system/queue@.service <<EOF
[Unit]
...
systemctl start queue@default.service
systemctl enable queue@default.service

systemctl start queue@monitor.service
systemctl enable queue@monitor.service

systemctl start queue@notifications.service
systemctl enable queue@notifications.service

systemctl start queue@notifications.service
systemctl enable queue@notifications.service

systemctl start queue@store-webhook.service
systemctl enable queue@store-webhook.service

systemctl start queue@store-webhook-retry.service
systemctl enable queue@store-webhook-retry.service
}
enable_transfer() {
...
systemctl start transfers@bitcoin.service
systemctl enable transfers@bitcoin.service

systemctl start transfers@tron.service
systemctl enable transfers@tron.service
}
